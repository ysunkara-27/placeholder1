...
// Cheapest Gemini model — swap to "gemini-2.0-flash" if you need better quality
...
- level: valid values are internship, new_grad, co_op, associate, part_time. Only suggest a change if the title clearly implies a different level than what's given.
...
Example: {"company": "Stripe", "title": "Software Engineer Intern"}`;
  ...
  try {
    ...
    // Strip fields identical to input
